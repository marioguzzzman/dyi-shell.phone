...
*A shell you hold to your ear — and instead of the sea, you hear the voices and memories people have left about water.*

Part of **[She Tells, Sea Shells](https://shetells.stream/)**, an art project about getting closer to water in a time of climate emergency. This repository is the open-source hardware for the *Shellphone*, so anyone can build their own.
